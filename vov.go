...
// service. It serves with a standard *http.Server the caller can fully configure.
// The App is only an assembler over the declarations; the declarations remain
// usable without it.
package vov
